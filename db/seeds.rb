...
unit_0 = Unit.create!(name: "Demo Unit", next_unit: 1, prev_unit: nil)
  ...
  lesson_1 = Lesson.create!( name: "Second Lesson", unit_id: unit_0.id )
    question_1 = Question.create!( title: "Each Unit will be unlocked when you pass all of the Lessons in the previous unit", lesson_id: lesson_1.id)
      Answer.create!(name: "✘", question_id: question_1.id, value: false)
      Answer.create!(name: "Got it", question_id: question_1.id, value: true)
      Answer.create!(name: "✘", question_id: question_1.id, value: false)
    question_2 = Question.create!( title: "You are all Set to Go!", lesson_id: lesson_1.id)
      Answer.create!(name: "Cool", question_id: question_2.id, value: true)
      Answer.create!(name: "Let's GO", question_id: question_2.id, value: true)
      Answer.create!(name: "✔", question_id: question_2.id, value: true)

unit_1 = Unit.create!(
name: "Arithmatic", next_unit: 2, prev_unit: 0)
